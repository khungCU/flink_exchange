...
docker exec -it broker kafka-topics --create \
    --bootstrap-server localhost:9092 --topic productsales

3) Create Kafka sink topic named productsales_out

docker exec -it broker kafka-topics --create \
    --bootstrap-server localhost:9092 --topic productsales_out
